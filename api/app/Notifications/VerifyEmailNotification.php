...
final class VerifyEmailNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(User $notifiable): MailMessage
    {
        ...
        $signedUrl = URL::temporarySignedRoute('verification.verify', now()->addMinutes($expireMinutes), [
        ...
        return $this->tenantMail(MailLogType::EmailVerification, 'E-Mail-Adresse bestätigen')
            ->markdown('mail.verify-email', [
                ...$this->tenantViewData(),
                'url' => SignedSpaUrl::toFrontend($signedUrl, '/email-verifizieren'),
            ]);
    }
}
